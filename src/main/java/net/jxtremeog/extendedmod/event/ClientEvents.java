package net.jxtremeog.extendedmod.event;

import net.jxtremeog.extendedmod.ExtendedMod;
import net.jxtremeog.extendedmod.client.FluidOverlay;
import net.jxtremeog.extendedmod.util.KeyBinding;
...
public class ClientEvents {
    @Mod.EventBusSubscriber(modid = ExtendedMod.MOD_ID, value = Dist.CLIENT)
    ...
    @Mod.EventBusSubscriber(modid = ExtendedMod.MOD_ID, value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.MOD)
