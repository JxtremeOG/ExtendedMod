...
public class TierTwoRecipeCategory implements IExtendableRecipeCategory<TierTwoRecipe, ICraftingCategoryExtension>{
    public final static ResourceLocation UID = new ResourceLocation(ExtendedMod.MOD_ID, "workbench_two");
    ...
    public TierTwoRecipeCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 85);
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ModBlocks.TIERTWO.get()));
        craftingGridHelper = helper.createCraftingGridHelper();
    }

    @Override
    public RecipeType<TierTwoRecipe> getRecipeType() {
        return JEIExtendedModPlugin.TIER_TWO_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.literal("Workbench Two");
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, TierTwoRecipe recipe, IFocusGroup focuses) {
    ...
    @Override
    public <R extends TierTwoRecipe> void addCategoryExtension(Class<? extends R> recipeClass, Function<R, ? extends ICraftingCategoryExtension> extensionFactory) {

    }

    @Override
    public <R extends TierTwoRecipe> void addCategoryExtension(Class<? extends R> recipeClass, Predicate<R> extensionFilter, Function<R, ? extends ICraftingCategoryExtension> extensionFactory) {
