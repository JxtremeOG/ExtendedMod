...
public class TierThreeShapedRecipe implements Recipe<CraftingContainer>{
    ...
    public TierThreeShapedRecipe(ResourceLocation id, int pWidth, int pHeight,
...
//        super(id); Needs to extend CustomRecipe to implement
    ...
    public static class Serializer implements RecipeSerializer<TierThreeShapedRecipe> {
        public static final Serializer WORKBENCH_THREE_SHAPED = new Serializer();
        public static final ResourceLocation ID =
                new ResourceLocation(ExtendedMod.MOD_ID, "workbench_three_shaped");
...
//        }
        @Override
        public TierThreeShapedRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
            Map<String, Ingredient> map = TierThreeShapedRecipe.keyFromJson(GsonHelper.getAsJsonObject(pJson, "key"));
            String[] astring = TierThreeShapedRecipe.shrink(TierThreeShapedRecipe.patternFromJson(GsonHelper.getAsJsonArray(pJson, "pattern")));
            int i = astring[0].length();
            int j = astring.length;
            NonNullList<Ingredient> nonnulllist = TierThreeShapedRecipe.dissolvePattern(astring, map, i, j);
            ItemStack itemstack = TierThreeShapedRecipe.itemStackFromJson(GsonHelper.getAsJsonObject(pJson, "result"));
            return new TierThreeShapedRecipe(pRecipeId, i, j, nonnulllist, itemstack);
        }

        @Override
        public @Nullable TierThreeShapedRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
            ...
            return new TierThreeShapedRecipe(id, i, j, nonnulllist, itemstack);
        }
        @Override
        public void toNetwork(FriendlyByteBuf buf, TierThreeShapedRecipe pRecipe) {
