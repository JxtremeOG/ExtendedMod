...
public class TierThreeShapelessRecipe implements Recipe<CraftingContainer>{
    ...
    public TierThreeShapelessRecipe(ResourceLocation id, ItemStack output,
...
//        }
        ...
        public TierThreeShapelessRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
            ...
            if (nonnulllist.isEmpty()) {
                ...
                return new TierThreeShapelessRecipe(pRecipeId, itemstack, nonnulllist);
            }
        }
        ...
        @Override
        public @Nullable TierThreeShapelessRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
            ...
            return new TierThreeShapelessRecipe(id, output, inputs);
        }
        @Override
        public void toNetwork(FriendlyByteBuf buf, TierThreeShapelessRecipe recipe) {
