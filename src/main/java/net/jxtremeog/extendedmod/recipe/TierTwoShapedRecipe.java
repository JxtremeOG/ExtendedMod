...
public class TierTwoShapedRecipe implements Recipe<CraftingContainer>{
    ...
    public TierTwoShapedRecipe(ResourceLocation id, int pWidth, int pHeight,
...
//        super(id); Needs to extend CustomRecipe to implement
    ...
    public RecipeSerializer<?> getSerializer() {
        return Serializer.WORKBENCH_TWO_SHAPED;
    }

    @Override
    public RecipeType<?> getType() {
        return Type.WORKBENCH_TWO_SHAPED;
    }

    public static class Type implements RecipeType<TierTwoShapedRecipe> {
        private Type() { }
        public static final Type WORKBENCH_TWO_SHAPED = new Type();
        public static final String ID = "workbench_two_shaped";
    }

    public static class Serializer implements RecipeSerializer<TierTwoShapedRecipe> {
        public static final Serializer WORKBENCH_TWO_SHAPED = new Serializer();
        public static final ResourceLocation ID =
                new ResourceLocation(ExtendedMod.MOD_ID, "workbench_two_shaped");
...
//        }
        @Override
        public TierTwoShapedRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
            Map<String, Ingredient> map = TierTwoShapedRecipe.keyFromJson(GsonHelper.getAsJsonObject(pJson, "key"));
            String[] astring = TierTwoShapedRecipe.shrink(TierTwoShapedRecipe.patternFromJson(GsonHelper.getAsJsonArray(pJson, "pattern")));
            int i = astring[0].length();
            int j = astring.length;
            NonNullList<Ingredient> nonnulllist = TierTwoShapedRecipe.dissolvePattern(astring, map, i, j);
            ItemStack itemstack = TierTwoShapedRecipe.itemStackFromJson(GsonHelper.getAsJsonObject(pJson, "result"));
            return new TierTwoShapedRecipe(pRecipeId, i, j, nonnulllist, itemstack);
        }

        @Override
        public @Nullable TierTwoShapedRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
            ...
            return new TierTwoShapedRecipe(id, i, j, nonnulllist, itemstack);
        }
        @Override
        public void toNetwork(FriendlyByteBuf buf, TierTwoShapedRecipe pRecipe) {
