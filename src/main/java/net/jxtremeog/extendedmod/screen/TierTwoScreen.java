...
public class TierTwoScreen extends TierTwoMenu {
    private final Block workbench;
    private final ContainerLevelAccess worldPos;

    public TierTwoScreen(int id, Inventory playerInv, ContainerLevelAccess worldPos, Block workbench) {
    ...
    public boolean stillValid(Player playerIn) {
        return TierTwoScreen.isWithinUsableDistance(this.worldPos, playerIn, this.workbench);
    }
}
