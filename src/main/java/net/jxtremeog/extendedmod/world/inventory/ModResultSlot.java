...
public class ModResultSlot extends Slot {
    ...
    public void onTake(Player pPlayer, ItemStack pStack) {
        ...
        NonNullList<ItemStack> nonnulllist = ((currentRecipe+"").contains("tier_one")) ? pPlayer.level.getRecipeManager().getRemainingItemsFor(TierOneRecipe.Type.WORKBENCH_ONE, this.craftSlots, pPlayer.level) :
